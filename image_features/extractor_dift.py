...
class OneStepSDPipeline(StableDiffusionPipeline):
    ...
    def __call__(
        ...
        # decode the noisy latent
        img_tensor_noisy = self.vae.decode(latents_noisy).sample.mean(dim=0)
        unet_output = self.unet(latents_noisy,
                                t,
                                up_ft_indices,
                                encoder_hidden_states=prompt_embeds,
                                cross_attention_kwargs=cross_attention_kwargs)
        return unet_output, img_tensor_noisy
...
class SDFeaturizer:
    ...
    def forward(self,
        ...
        unet_ft_all, reconstructed_noisy = self.pipe(
        ...
        return unet_ft, reconstructed_noisy
