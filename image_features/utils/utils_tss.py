...
def pad_to_same_shape(im1, im2, flow, mask):
    ...
    # image_scene are padded to the right and bottom so it does not change values of the flow estimated.
...
class TSSDataset(data.Dataset):
    ...
    def __init__(self, root, source_image_transform=None, target_image_transform=None, flow_transform=None,
        ...
        Args:
            ...
            source_image_transform: image transformations to apply to source image_scene
            target_image_transform: image transformations to apply to target image_scene
            flow_transform: flow transformations to apply to ground-truth flow fields
            co_transform: transformations to apply to both image_scene and ground-truth flow fields
